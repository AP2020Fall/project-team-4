...
public class Reversi extends Game {
    ...
    public Gamer getWinner() {
        if (getNumberOfBlack() > getNumberOfWhite())
            return (((PlayerReversi) listOfPlayers.get(0)).getColor().equals("b")) ? listOfPlayers.get(0).getGamer() : listOfPlayers.get(1).getGamer();
        else if (getNumberOfBlack() < getNumberOfWhite())
            return (((PlayerReversi) listOfPlayers.get(0)).getColor().equals("b")) ? listOfPlayers.get(1).getGamer() : listOfPlayers.get(0).getGamer();
        else return null;
