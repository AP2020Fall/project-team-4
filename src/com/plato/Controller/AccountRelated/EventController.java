...
public class EventController {
	...
	public void createEvent () {
		...
		String gameNum;
		while (true) {
			Menu.print("Choose Game:[/c to cancel] "); gameNum = String.valueOf(Integer.parseInt(Menu.getInputLine()));
		...
		while (true) {
			try {
				Menu.print("Start Date[d-MMM-yyyy][/c to cancel]: "); start = LocalDate.parse(Menu.getInputLine(), DateTimeFormatter.ofPattern("d-MMM-yyyy"));
		...
		while (true) {
			try {
				Menu.print("End Date[d-MMM-yyyy][/c to cancel]: "); end = LocalDate.parse(Menu.getInputLine(), DateTimeFormatter.ofPattern("d-MMM-yyyy"));
		...
		while (true) {
			try {
				Menu.print("Event Prize[/c to cancel]: "); eventPrize = Double.parseDouble(Menu.getInputLine());
	...
	public void displayEventInfo () {
		...
		while (true)
			try {
				Menu.print("Event ID:[/c to cancel] "); eventid = Menu.getInputLine();
	...
	public void stopParticipatingInEvent () {
		...
		while (true)
			try {
				Menu.print("Event ID:[/c to cancel] "); String eventid = Menu.getInputLine();
